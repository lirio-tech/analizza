...
└── cars/                    # outro domínio/projeto
```

## Responsabilidades

- `properties-api` e `properties-core` concentram o backend do domínio `properties`.
...
- o frontend do domínio `properties` é executado a partir de [`properties/package.json`](/home/diegolirio/Documents/Github/analizza/analizza/properties/package.json), de forma independente.
- `cars` é um domínio separado e segue a mesma lógica de estrutura quando for criado.
